...
(function () {
    ...
    window.computeGrid = function (player, unit, removCb) {
        var ax, ay, badParts, ey, getXY, grid, i, j, k, l, len, len1, len2, m, n, newSet, o, openSet, p, part, parts,
            px, py, q, r, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref19, ref2, ref20,
            ref21, ref22, ref23, ref24, ref25, ref26, ref27, ref28, ref29, ref3, ref30, ref4, ref5, ref6, ref7, ref8,
            ref9, root, s, size, t, u, ws, x, y;
        parts = unit.parts;
        getXY = function (part) {
            var size, x, y;
            size = partSize(part);
