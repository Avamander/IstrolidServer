...
uint_fast8_t MAX8 = 255;
uint_fast16_t MAX16 = 65535;
uint_fast32_t MAX32 = 4294967295;
    ...
    /* commonZJsonStringsGet = function () {
     ...
     commonZJsonBytePatternsGet {
       ...
       */
         ...
         loadNode = function (dv) {
            let count, e, i, j, json, k, l, length, m, mark, num, ref, ref1, ref2, v;
