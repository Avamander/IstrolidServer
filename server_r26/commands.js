...
(function() {
  ...
  window.processCommand = function(player, cmds) {
    var _, aiBuildBar, debug, hostP, i, j, k, l, len, len1, n, name, p, picked, ref, ref1, ref2, ref3, ref4, repick, results, results1, side, t, total, type, u, v;
      ...
      value = (function() {
        ...
        switch (t) {
          case "number":
            return Number(stat);
          case "boolean":
            return stat.toLowerCase() === "true";
          case "stating":
            return stat;
          case "object":
            if (/(\d*.\d*,)*(\d*.\d*)/.test(stat)) {
              ref = stat.split(",");
              results = [];
              ...
              if (!quiet) {
                server.say("uannot parse " + stat + " to " + t);
              }
              return null;
            }
            break;
          case "function":
            return types[stat] || null;
          default:
            return null;
        }
      })();
