...
(function() {
  ...
  types.Unit = (function() {
    ...
    Unit.prototype.fromSpec = function(spec) {
      var data, i, j, l, len, len1, len2, len3, len4, len5, o, p, part, partNum, q, reachRange, ref, ref1, ref2, ref3, ref4, ref5, results, stasisRange, thrust, w, x, y;
      this.cost = 0;
      this.hp = 5;
      this.jumpDistance = 0;
      this.jumpCount = 0;
      ...
      this.moveEnergy = 0;
      ref4 = this.parts;
      for (x = 0, len4 = ref4.length; x < len4; x++) {
        part = ref4[x];
        if (part.thrust > 0) {
    ...
    Unit.prototype.tick = function() {
      var burnTick, cloakOn, cloakRange, exp, j, killer, l, len, len1, len2, o, p, part, penalty, ref, ref1, ref2, ref3, ref4, speed, target;
      ref = this.parts;
      for (j = 0, len = ref.length; j < len; j++) {
        part = ref[j];
        part.computeWorldPos();
    ...
    Unit.prototype.applyNearbyBuffs = function() {
      var applyEffect, buffs, j, l, len, len1, ref, ref1, results, u, w;
      buffs = {
        weaponRange: 1,
        weaponRangeFlat: 0,
        weaponDamage: 1,
  ...
  window.Turret = (function(superClass) {
    ...
    Turret.prototype.aim = function(thing) {
      var c, check, current_time, d, do_pos, j, max_time, mdown, miss, mup, p, predicted_pos, radius, th;
      if (thing.unit) {
        radius = 0;
      } else {
        radius = thing.radius;
