...
(function() {
  var blue, bluebrown, chooseNumber, chooseOne, darkness, fadered, genBox, genCTF, genClouds, genDebree, genDodads, genFFA, genIO, genRocks, genSurvival, genSymetrical, genTTT, grayblue, greenbrown, greenpurple, lemondarkred, main, moonyellow, orange, pinkpurple, randomVector, redgreen, tanslate, tealorange, tealwhite, whitepurple, yellowcyan, yellowpuce;
  ...
  genCTF = function() {
    var _, a, alphaSpawn, b, betaSpawn, createFlag, flag, from_center, homePoints, i, len, m, o, point, pos, q, ref, ref1, ref2, results, t, tooClose;
    createFlag = function() {
      var flag;
      flag = new types.Rock();
      flag.flag = true;
  ...
  genFFA = function() {
    var cp, i, m, makePoint, o, p, player, players, ref, ref1, results, sp, th;
