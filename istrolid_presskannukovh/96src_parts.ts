...
import {Engine, Part, Turret, Unit, UnitUtils} from "./95src_unit";
...
export class JumpEngine extends Engine {
    ...
    draw() {
        super.draw.call(this);
        if (this.working) {
            return baseAtlas.drawSprite("export class engineJumpPip.png", this.worldPos, [1, 1], this.unit.rot, null);
        }
    };
}
...
export class TorpBullet extends StraightMissile {
    ...
    image = "export class fireTorp1.png";
...
export class MissileBullet extends TrackingMissile {
    image = "export class fireMis1.png";
...
export class FlameWarhead extends Part {
    ...
    postDeath() {
        ...
        exp.side = this.unit.side;
        exp.owner = this.unit.owner;
        exp.image = "export class fireFlame";// + (chooseInt(1, 4)) + ".png";
        exp.z = 1000;
        exp.pos = v2.create(this.worldPos);
        exp.vel = new Float64Array([0, 0]);
        exp.rot = (Math.random() - 0.5) * 100;
