...
(function () {
    ...
    window.Sim = (function () {
        ...
        Sim.prototype.whoIsHost = function () {
            let haveHost, l, len1, len2, m, p, ref, ref1, results;
            haveHost = false;
            ref = this.players;
            for (l = 0, len1 = ref.length; l < len1; l++) {
                p = ref[l];
        ...
        Sim.prototype.send = function () {
            let _, changes, data, e, f, i, id, l, len1, len2, len3, len4, len5, len6, len7, len8, m, o, p, packet, part,
                partId, player, predictable, q, r, ref, ref1, ref10, ref11, ref12, ref13, ref2, ref3, ref4, ref5, ref6,
