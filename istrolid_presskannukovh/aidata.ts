    ...
    static readonly all: {
        ...
        "AlphaStriker": [{
            ...
            "aiRules": [
                ...
                ["Field # for # of enemy @unitTypes at priority #", 1, 1, "Cruiser", 3],
                ["Field # for # of enemy @unitTypes at priority #", 1, 1, "Carrier", 3],
        ...
        "FireShower": [{
            ...
            "aiRules": [
                ...
                ["@attackTypes enemy that is @relativeTypes and @relativeTypes within #m", "Flee", "Stronger", "---", 500], ["Avoid over #damage shots", 20], ["@attackTypes enemy that is @absoluteTypes then # within #m", "Kite", "Slower", 100, 1500], ["@attackTypes enemy that is @relativeTypes and @relativeTypes within #m", "Ram", "Cloaked", "More expensive", 2000], ["@attackTypes enemy that is @relativeTypes and @relativeTypes within #m", "Ram", "Slower", "Less DPS", 2000], ["@attackTypes enemy that is @relativeTypes and @relativeTypes within #m", "Kite", "Slower", "More expensive", 3000], ["@capTypes Command Points within #m", "Protect", 2000], ["When #% of energy, @chargeTypes", 85, "Find recharger"], ["@capTypes Command Points within #m", "Spread to", 10000], ["Field # for # of @needTypes at priority #", 1, 4, "Cloak Counter Need", 5], ["Field # at priority #", 1, 4], ["Field # when money over # at priority #", 1, 1000, 1], ["Field # at priority #", 2, 6]]
        }, {
        ...
        "Micor": [{
            ...
            "parts": [{"pos": [-10, 0], "type": "Engine04", "dir": 0}, {
                "pos": [-10, 30],
                "type": "Battery1x1",
                "dir": 0
            }],
