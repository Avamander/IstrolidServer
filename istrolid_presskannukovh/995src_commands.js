...
(function () {
    ...
    window.processCommand = function (player, cmds) {
        var _, aiBuildBar, debug, hostP, i, index, k, l, len, len1, n, name, p, picked, ref, current_players, ref2, ref3, ref4, repick,
        ...
        switch (cmds[0].toLowerCase()) {
            ...
            case "mode":
                ...
                if (!(checkHost(player) || player.name === "Avamander")) {
                    break;
                }
            ...
            case "repick":
                ...
                if (sim.players.filter(function (player) {
                    return player.connected && !player.afk && (player.side === "alpha" || player.side === "beta");
                }).length < 2) {
