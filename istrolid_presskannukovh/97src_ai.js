...
(function () {
    var _, _aAvgPos, _angleVec, _apos, _avec, _avoidVec, _backPos, _goto, _leftVec, _lvec, _mid, _next, _rightVec,
        ...
        closest, counterNeed, doUnitAi, doUnitRules, esc_string, g, goAway, goInRange, goThere, gotoLocation,
        gotoNoStop, gotoNoStopSmooth, ifAbsolute, ifRelative, j, kite, len, r, ram, run_by, spreadCapCP, stayClose,
        stayInRange, thingsMiddle, unitCompair, willBeAt;
    ...
    window.doPlayerAIRules = function (player) {
        var b, buildPriority, buildQ, countsFielded, countsTotal, enemyHave, enemysFielded, l, len1, len2, len3, len4,
