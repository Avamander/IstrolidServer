...
(function() {
  ...
  galaxyMap.generateStub = function() {
    var _r, a, allStars, b, bossStar, d, data, dist, emptyStar, hasPart, i, i1, interct, j, j1, justWon, k, k1, l, l1, len, len1, len10, len11, len12, len2, len3, len4, len5, len6, len7, len8, len9, m, m1, myStar, n, o, other, p, p1, p2, part, path, paths, pos, q, r, ref, s, spec, star, starNames, starPosList, stars, u, unlockedParts, v, w, x, y, z;
    ...
    for (z = 0, len9 = easyPlayerBuildBar.length; z < len9; z++) {
      ...
      ref = fromShort(spec);
      for (i1 = 0, len10 = ref.length; i1 < len10; i1++) {
        p = ref[i1];
        unlockedParts[p.type] = true;
      }
    }
    allStars = (function() {
      var j1, len11, results;
      results = [];
      for (j1 = 0, len11 = stars.length; j1 < len11; j1++) {
        s = stars[j1];
    ...
    emptyStar = (function(_this) {
      return function() {
        var k1, len11;
        for (k1 = 0, len11 = stars.length; k1 < len11; k1++) {
          star = stars[k1];
          if (star.type === "home" || star.type === "boss") {
            continue;
          }
    ...
    data = [];
    for (l1 = 0, len11 = stars.length; l1 < len11; l1++) {
      star = stars[l1];
    ...
    data += "\n\n";
    for (m1 = 0, len12 = paths.length; m1 < len12; m1++) {
      p = paths[m1];
